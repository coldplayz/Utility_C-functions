...
def create_app():
    ...
    app.config["SP_IMAGE_PATH"] = path.join(
            app.static_folder, 'service_providers/images/'
            )
    app.config["SP_IMAGE_RPATH"] = 'static/service_providers/images/'
    app.config["CUS_IMAGE_PATH"] = path.join(
            app.static_folder, 'customers/images/'
            )
    app.config["CUS_IMAGE_RPATH"] = 'static/customers/images/'
    app.config["SPS_IMAGE_PATH"] = path.join(
