...
def publish_messages_with_custom_attributes(project_id: str, topic_id: str) -> None:
    ...
    data_str = '{"txPath": "users_transactions_withdrawal/uid1/utility/hashelectricity"}'
    data = data_str.encode("utf-8")
    future = publisher.publish(
        topic_path, data, jwt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NDg4MDc3ODYsInN1YiI6Ik5haXJhTWVtcG9vbCIsImV4cCI6MTc0ODgwODM4Niwic2VjcmV0cyI6Ii9ublFSZWhvcjJNVTlqaVFvaThLalE9PSJ9.nIhAsn3FvPiOSknpy1EHaOIxAzfIk2dsvpIrKQLymoc"
        )
    print(future.result())
