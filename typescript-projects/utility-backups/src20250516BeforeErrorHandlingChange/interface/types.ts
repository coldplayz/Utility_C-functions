...
import { AppTxStatus, PlanType, ProviderId, Utility } from "./enums";
...
export type TUtilityMeta = TEbillsUtilityMeta;
export type TEbillsUtilityMeta = {
  // /** Unique identifier for the customer, at the merchant */
  // customerId: string;
