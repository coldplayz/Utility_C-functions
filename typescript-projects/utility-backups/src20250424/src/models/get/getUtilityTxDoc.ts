...
const txDocRule = {
  ...
  "utilityMeta.planId": `required_if:utilityMeta.merchantServiceId,${UtilityMerchantService.Plan}|string`,
  "utilityMeta.amount": `required_unless:utilityMeta.merchantServiceId,${UtilityMerchantService.Plan}|isNumber`,
