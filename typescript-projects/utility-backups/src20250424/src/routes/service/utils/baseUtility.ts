  ...
  static validatePaymentData(data: TPaymentData) {
    ...
    if (!paymentDataValidator.validate(data))
      throw new ErrorHandler("Error validating utility payment data", true, {
        ...
        invalidData: data,
        source: this.validatePaymentData.name,
      });
  }
}
...
const paymentDataRule = {
  ...
  "planData.amount": `required_with:planId|isNumber`,
  "planData.planCode": "required_with:planId|string",
  "planData.providerId": "required_with:planId|isProviderId",
