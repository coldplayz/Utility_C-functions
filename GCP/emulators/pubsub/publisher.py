...
def publish_messages_with_custom_attributes(project_id: str, topic_id: str) -> None:
    ...
    # My (Greenbel) change start
    data_str = '{"tradedUids": ["eX7jGEUFafeZNzELxNA67Eb8EGY2"], "uid": "clc6YTmS8UbUJJmxSMbAoCIHt5B2"}'
    data = data_str.encode("utf-8")
    future = publisher.publish(
            topic_path, data, jwt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3NDIyMTIwMzgsInN1YiI6Ik5haXJhQ3JlZGl0UmVxdWVzdCIsImV4cCI6MTc0MjIxMjMzOCwic2VjcmV0cyI6ImgwbStYMHlEQnBmeWlmcE4wSXNSaTdTcU4wa0ZBQnE5MUdkcnNlQzM0b0owTm9yQXh5N2hsUi9CVTg3RlhwcXQifQ.WqmpsLaD95yLqlULptBjufq4yJQNgmCuTK0YPgz7-FU"
        )
    print(future.result())
    # My (Greenbel) change end
